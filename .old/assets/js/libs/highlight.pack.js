/*! highlight.js v9.13.1 | BSD3 License | git.io/hljslicense */ ! function ( e ) {
    ...
    function i( e ) {
        ...
        if ( s += e.parentNode ? e.parentNode.className : "", r = B.exec( s ) ) return w( r[ 1 ] ) ? r[ 1 ] : "no-highlight";
    ...
    function d( e, r, n, i ) {
        ...
        function c( e, t ) {
            ...
            for ( r = 0, n = t.c.length; n > r; r++ )
                if ( a( t.c[ r ].bR, e ) ) return t.c[ r ].endSameAsBegin && ( t.c[ r ].eR = s( t.c[ r ].bR.exec( e )[ 0 ] ) ), t.c[ r ]
        }
        ...
        function f() {
            var e, r, a, n;
            if ( !k.k ) return t( M );
            for ( n = "", r = 0, k.lR.lastIndex = 0, a = k.lR.exec( M ); a; ) n += t( M.substring( r, a.index ) ), e = p( k, a ), e ? ( B += e[ 1 ], n += m( e[ 0 ], t( a[ 0 ] ) ) ) : n += t( a[ 0 ] ), r = k.lR.lastIndex, a = k.lR.exec( M );
        ...
        function v( e, t ) {
            if ( M += e, null == t ) return _(), 0;
            var r = c( t, k );
            if ( r ) return r.skip ? M += t : ( r.eB && ( M += t ), _(), r.rB || r.eB || ( M = t ) ), h( r, t ), r.rB ? 0 : t.length;
            var a = o( k, t );
            if ( a ) {
                var n = k;
                n.skip ? M += t : ( n.rE || n.eE || ( M += t ), _(), n.eE && ( M = t ) );
                do k.cN && ( C += R ), k.skip || k.sL || ( B += k.r ), k = k.parent; while ( k !== a.parent );
        ...
        var N, k = i || y,
            x = {},
            C = "";
        for ( N = k; N !== y; N = N.parent ) N.cN && ( C = m( N.cN, "", !0 ) + C );
        var M = "",
            B = 0;
        try {
            for ( var L, A, $ = 0;; ) {
                if ( k.t.lastIndex = $, L = k.t.exec( r ), !L ) break;
                A = v( r.substring( $, L.index ), L[ 0 ] ), $ = L.index + A
            }
            for ( v( r.substr( $ ) ), N = k; N.parent; N = N.parent ) N.cN && ( C += R );
            return {
                r: B,
                value: C,
                language: e,
